...
option tokenizer, diagnostics, and tests). Documentation/evidence updates are
on the same draft branch.
...
All required local baseline and policy checks pass on `9086fa9` plus the docs
changes:
