...
The documentation closeout will trigger the repository’s full native feasibility
matrix; its final links will be appended to the evidence record before the next
slice begins.
