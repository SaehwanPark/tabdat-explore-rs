...
- [x] Create `tabdat-language` (bounded syntax-only parser foundations; PRs #11–#13).
...
- [x] Port bounded syntax-only control/status/inspection forms (`help`, `status`,
  `exit`, `describe`, `count`, `head`, and `tail`; PRs #11–#13).
